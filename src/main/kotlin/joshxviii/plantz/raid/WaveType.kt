    ...
    companion object {
        ...
        fun getPotentialBonusSpawns(
            ...
            when (type) {
                ...
                ZombieRaiderType.ZOMBIE_YETI -> bonusSpawns = if (!isEasy && wave > 3) 1 + (raid.zombieRaidOmenLevel / 3) else 0
                ...
                ZombieRaiderType.ENGINEER_ZOMBIE -> bonusSpawns = if (creditsUnlocked && wave > 1) 1 + (raid.zombieRaidOmenLevel / 3) else 0
...
enum class ZombieRaiderType(
    ...
    DIGGER_ZOMBIE(PazEntities.DIGGER_ZOMBIE,       intArrayOf(0,      1,      1,      0,      4,      1,      1,      2,      3,    3 )),
    ...
    ENGINEER_ZOMBIE(PazEntities.ENGINEER_ZOMBIE,   intArrayOf(0,      0,      1,      3,      1,      1,      2,      2,      3,    4 ), true),
    SOLDIER_ZOMBIE(PazEntities.SOLDIER_ZOMBIE,     intArrayOf(0,      0,      0,      0,      0,      0,      0,      0,      0,    10), true),
