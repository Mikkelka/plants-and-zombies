...
object PazParticles {
    @JvmField
    val ELECTRIC_ARC = ParticleRenderType(pazResource("electric_arc").toString(), pazResource("electric_arc").toString())
    @JvmField
    val BEAM = ParticleRenderType(pazResource("beam").toString(), pazResource("beam").toString())
